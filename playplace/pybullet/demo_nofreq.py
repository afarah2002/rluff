...
class Buffer:
    ...
    # TensorFlow to build a static graph ounp.squeezenp.squeezenp.squeezenp.squeezenp.squeezenp.squeezenp.squeezet of the logic and computations in our function.
